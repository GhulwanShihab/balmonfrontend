// src/components/DaftarInstagram.jsx
                        ...
                        {currentItems.map((data, index) => (
                            <Col md={4} className="mb-4" key={index}>
                                <Card className="h-100">
                                    <Card.Img variant="top" src={`http://localhost:3000/${data.fotoInstagram}`} alt="Instagram Image" className="img-fluid" />
                                    <Card.Body>
                                        <Card.Title>{data.judulInstagram}</Card.Title>
                                        <Card.Text>
                                            Author: {data.authorInstagram}
                                        </Card.Text>
                                        <Card.Text>
                                            Tanggal Publish: {data.tanggalInstagram}
                                        </Card.Text>
                                        <Link to={`/instagram/${data.id}`}>
...
export default DaftarInstagram;
